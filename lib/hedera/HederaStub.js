...
class HederaStub {
    ...
    createTopic(submitKey, topicMemoObject) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const topicCreationResponse = yield topicCreateTransaction.execute(this.client);
            const topicCreationReceipt = yield topicCreationResponse.getReceipt(this.client);
            return ((_a = topicCreationReceipt.topicId) === null || _a === void 0 ? void 0 : _a.toString()) || '';
        });
    }
    updateTopicMemo(topicMemoObject, topicId) {
        return __awaiter(this, void 0, void 0, function* () {
            const topicUpdateTransaction = new sdk_1.TopicUpdateTransaction({
                topicId: topicId,
                topicMemo: JSON.stringify(topicMemoObject),
                adminKey: sdk_1.PrivateKey.fromString(this.hederaPrivateKey)
            });
            topicUpdateTransaction.freezeWith(this.client);
            yield topicUpdateTransaction.sign(sdk_1.PrivateKey.fromString(this.hederaPrivateKey));
            yield topicUpdateTransaction.execute(this.client);
        });
    }
