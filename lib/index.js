    ...
    */
    ...
    getMessage(sequenceNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.topicMemoObject.s.m.f) {
                ...
                topicEncryptionKeyAndInitVector = yield this.getEncryptionKeyAndInitVector(encryptedMessage.v);
    ...
    rotateTopicEncryptionKey() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const fileContents = yield this.hederaStub.getFileContents(this.topicMemoObject.s.c.i);
