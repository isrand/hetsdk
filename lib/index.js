    ...
    getMessage(sequenceNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.topicMemoObject.s.m.f) {
                ...
                const encryptedMessageInBase64 = yield this.getFileContents(Buffer.from(fileId, 'base64').toString('utf8'));
    ...
    setConfigurationMessage() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.topicMemoObject.s.c.f) {
                ...
                this.topicConfigurationMessage = yield this.getFileContents(this.topicMemoObject.s.c.i);
