...
const StorageOption_1 = require("./hedera/enums/StorageOption");
    ...
    create(createEncryptedTopicConfiguration) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (createEncryptedTopicConfiguration.storageOptions.configuration === StorageOption_1.StorageOption.File) {
        ...
        return {
            s: {
                c: {
                    ...
                    u: topicStorageOptions.configuration === StorageOption_1.StorageOption.File,
                },
                m: {
                    u: topicStorageOptions.messages === StorageOption_1.StorageOption.File
                }
            }
        };
    }
