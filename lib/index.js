    ...
    */
    ...
    getEncryptionAlgorithmFromConfigurationMessage() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.topicConfigurationMessage.split('#')[TopicConfigurationMessageIndexes_1.TopicConfigurationMessageIndexes.TOPIC_ENCRYPTION_ALGORITHM_INDEX];
        });
    }
    getEncryptionSizeFromConfigurationMessage() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Number(this.topicConfigurationMessage.split('#')[TopicConfigurationMessageIndexes_1.TopicConfigurationMessageIndexes.TOPIC_ENCRYPTION_SIZE_INDEX]);
        });
    }
    setMemo() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getSubmitKey() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const encryptedTopicDataInBase64 = this.topicConfigurationMessage.split('#')[TopicConfigurationMessageIndexes_1.TopicConfigurationMessageIndexes.TOPIC_DATA_INDEX];
            const encryptedTopicKeysObject = yield this.getEncryptedTopicKeysObjectFromTopicConfigurationMessage();
    ...
    getEncryptedTopicKeysObjectFromTopicConfigurationMessage() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let encryptedTopicKeysObjectArray = this.topicConfigurationMessage.split('#').slice(TopicConfigurationMessageIndexes_1.TopicConfigurationMessageIndexes.TOPIC_ENCRYPTED_KEYS_INDEX);
