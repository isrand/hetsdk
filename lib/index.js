...
class EncryptedTopic {
    ...
    create(createEncryptedTopicConfiguration) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const topicConfigurationMessage = this.createTopicConfigurationMessage(encryptedTopicConfigurationObjectInBase64, topicEncryptionConfigurationInBase64);
            ...
            try {
                ...
                if (createEncryptedTopicConfiguration.storageOptions.configuration === StorageOptions_1.StorageOptions.File) {
                    ...
                    const fileCreateTransaction = new sdk_1.FileCreateTransaction({
                        keys: [sdk_1.PrivateKey.fromString(this.hederaConfiguration.hederaPrivateKey).publicKey]
                    });
    ...
    addParticipants(topicId, participants, privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const topicMemoObject = yield this.getMemo(topicId);
            ...
            // Remove doubles from participants array
            const uniqueParticipantsArray = participants.filter((obj, index, self) => index === self.findIndex(o => (o.hederaPublicKey === obj.hederaPublicKey || o.publicKey === obj.publicKey)));
            // Get topic encryption key and init vector
            const topicEncryptionKeyAndInitVector = yield this.getEncryptionKeyAndInitVector(topicId, privateKey);
            // Encrypt topic encryption key and init vector with new participant public keys
            const newEncryptedTopicEncryptionKeyAndInitVectors = this.crypto.getEncryptedTopicKeysObject(Buffer.from(topicEncryptionKeyAndInitVector.encryptionKey, 'base64'), Buffer.from(topicEncryptionKeyAndInitVector.initVector, 'base64'), uniqueParticipantsArray);
            // Get old encrypted topic keys object containing already encrypted topic encryption keys and init vectors
            const encryptedTopicKeysObject = yield this.getEncryptedTopicKeysObjectFromTopicConfigurationMessage(topicId);
            // Merge old encrypted topic encryption keys and init vectors with new ones for new participants
            const newEncryptedTopicKeysObject = {
            ...
            const topicAlgorithm = yield this.getTopicEncryptionAlgorithmFromTopicConfigurationMessage(topicId);
            ...
            const topicEncryptionSize = yield this.getTopicEncryptionSizeFromTopicConfigurationMessage(topicId);
            ...
            const topicConfigurationMessage = JSON.parse(Buffer.from(this.topicConfigurationMessageInBase64, 'base64').toString('utf8'));
    ...
    submitMessage(topicId, message, privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const submitKey = yield this.getSubmitKey(topicId, privateKey);
    ...
    getParticipants(topicId, privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            const topicConfigurationObject = yield this.getTopicConfigurationObject(topicId, privateKey);
    ...
    createTopicConfigurationMessage(topicConfigurationObjectInBase64, topicEncryptionConfigurationInBase64) {
        return {
            a: topicConfigurationObjectInBase64,
            b: topicEncryptionConfigurationInBase64
        };
    }
    createMemoObject(topicStorageOptions, topicConfigurationFileId) {
        return {
            s: {
                c: {
    ...
    getEncryptedTopicKeysObjectFromTopicConfigurationMessage(topicId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.topicConfigurationMessageInBase64) {
                yield this.setConfigurationMessageInBase64(topicId);
            }
            const topicConfigurationMessage = JSON.parse(Buffer.from(this.topicConfigurationMessageInBase64, 'base64').toString('utf8'));
    ...
    getTopicConfigurationObject(topicId, privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.topicConfigurationMessageInBase64) {
                yield this.setConfigurationMessageInBase64(topicId);
            }
            if (!this.crypto) {
                yield this.initializeCrypto(this.topicConfigurationMessageInBase64);
            }
            return this.crypto.decryptTopicConfigurationMessage(this.topicConfigurationMessageInBase64, privateKey);
        });
    }
    getTopicEncryptionAlgorithmFromTopicConfigurationMessage(topicId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.topicConfigurationMessageInBase64) {
                yield this.setConfigurationMessageInBase64(topicId);
            }
    ...
    getTopicEncryptionSizeFromTopicConfigurationMessage(topicId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.topicConfigurationMessageInBase64) {
                yield this.setConfigurationMessageInBase64(topicId);
            }
    ...
    getEncryptionKeyAndInitVector(topicId, privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.topicConfigurationMessageInBase64) {
                yield this.setConfigurationMessageInBase64(topicId);
            }
    ...
    setConfigurationMessageInBase64(topicId) {
        return __awaiter(this, void 0, void 0, function* () {
            const topicMemoObject = yield this.getMemo(topicId);
    ...
    initializeCrypto(topicConfigurationMessageInBase64) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getSubmitKey(topicId, privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            const topicConfigurationObject = yield this.getTopicConfigurationObject(topicId, privateKey);
