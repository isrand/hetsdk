...
class EncryptedTopic {
    ...
    create(createEncryptedTopicConfiguration) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const topicConfigurationObject = this.createTopicConfigurationMessage(encryptedTopicDataInBase64, topicEncryptionDataInBase64);
            const topicConfigurationObjectInBase64 = Buffer.from(JSON.stringify(topicConfigurationObject)).toString('base64');
            try {
