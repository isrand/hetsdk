...
class EncryptedTopic {
    ...
    */
    ...
    addParticipant(topicId, publicKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const topicEncryptionKeyAndInitVector = yield this.getEncryptionKeyAndInitVector(topicId);
            ...
            if (topicMemoObject.s.p.p) {
                const submitKey = yield this.getSubmitKey(topicId);
                const topicSubmitMessageTransaction = new sdk_1.TopicMessageSubmitTransaction({
    ...
    */
    ...
    getTopicConfigurationObject(topicId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.topicConfigurationMessageInBase64) {
                yield this.setConfigurationMessageInBase64(topicId);
            }
    ...
    getEncryptionKeyAndInitVector(topicId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.topicConfigurationMessageInBase64) {
                yield this.setConfigurationMessageInBase64(topicId);
            }
    ...
    getSubmitKey(topicId) {
        return __awaiter(this, void 0, void 0, function* () {
            const topicConfigurationObject = yield this.getTopicConfigurationObject(topicId);
