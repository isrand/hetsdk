...
class EncryptedTopic {
    ...
    create(createEncryptedTopicConfiguration) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.topicConfigurationMessage.length > maxAllowedMessageSize && createEncryptedTopicConfiguration.storageOptions.configuration === StorageOptions_1.StorageOptions.Message) {
                throw new Error(Errors_1.Errors.TopicConfigurationMessageMaximumConsensusMessageSizeExceeded);
            }
            let fileId;
            ...
            if (createEncryptedTopicConfiguration.storageOptions.storeParticipants) {
                participantsTopicId = yield this.createParticipantsTopic(submitKey, Array.from(new Set(createEncryptedTopicConfiguration.participants)));
            }
    ...
    addParticipant(publicKey, forwardSecrecy) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.topicMemoObject.s.c.f) {
                throw new Error(Errors_1.Errors.AddParticipantToConsensusServiceTopic);
            }
    ...
    submitMessage(message, medium) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const maxAllowedMessageSize = 20 * 1024;
            if (finalMessageInBase64.length > maxAllowedMessageSize && medium === StorageOptions_1.StorageOptions.Message) {
                throw new Error(Errors_1.Errors.MaximumMessageSizeExceededAfterEncryption);
            }
            const submitKey = yield this.getSubmitKey(currentConfigurationMessageVersion);
            if (medium === StorageOptions_1.StorageOptions.File) {
    ...
    getMessage(sequenceNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const size = yield this.getEncryptionSizeFromConfigurationMessage();
            this.initializeCrypto(algorithm, size);
            let encryptedMessageInBase64 = yield this.getMessageFromTopic(sequenceNumber);
            ...
            if (this.looksLikeFileId(encryptedMessageInBase64)) {
                finalMessage = yield this.hederaStub.getFileContents(encryptedMessageInBase64);
                while (this.isBase64Encoded(finalMessage)) {
                    finalMessage = Buffer.from(finalMessage, 'base64').toString('utf8');
                }
            }
            const encryptedMessage = JSON.parse(finalMessage);
    ...
    getParticipants() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.setMemo();
            if (!this.topicMemoObject.s.p.p) {
                throw new Error(Errors_1.Errors.GetParticipantsFromTopicWithoutStoredParticipants);
            }
    ...
    rotateEncryptionKey() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.setConfigurationMessage();
            if (!this.topicMemoObject.s.c.f) {
                throw new Error(Errors_1.Errors.RotateEncryptionKeyOnConsensusServiceTopic);
            }
            if (!this.topicMemoObject.s.p.p) {
                throw new Error(Errors_1.Errors.RotateEncryptionKeyOnTopicWithoutStoredParticipants);
            }
    ...
    migrateConfigurationStorageMedium() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.setConfigurationMessage();
            if (this.topicMemoObject.s.c.f) {
                throw new Error(Errors_1.Errors.MigrateFileServiceTopicToFileServiceTopic);
            }
            const fileId = yield this.hederaStub.createFile();
            yield this.hederaStub.appendToFile(fileId, this.topicConfigurationMessage);
            const newTopicMemoObject = this.topicMemoObject;
            newTopicMemoObject.s.c.f = true;
            newTopicMemoObject.s.c.i = fileId;
            yield this.hederaStub.updateTopicMemo(newTopicMemoObject, this.topicId);
        });
    }
    /*
    ...
    storeParticipants(oldParticipantsPublicKeys) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.setConfigurationMessage();
            if (this.topicMemoObject.s.p.p) {
                throw new Error(Errors_1.Errors.TopicParticipantsAlreadyStored);
            }
            const currentConfigurationMessageVersion = yield this.getCurrentTopicConfigurationMessageVersion();
            const submitKey = yield this.getSubmitKey(currentConfigurationMessageVersion);
            const participantsTopicId = yield this.createParticipantsTopic(submitKey, oldParticipantsPublicKeys);
            const newTopicMemoObject = this.topicMemoObject;
    ...
    createParticipantsTopic(submitKey, participants) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getMessageFromTopic(sequenceNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (Number(sequenceNumber) > Number(topicInfo.sequenceNumber)) {
                throw new Error(Errors_1.Errors.TopicSequenceNumberLowerThanRequested);
            }
