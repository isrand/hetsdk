...
class EncryptedTopic {
    ...
    */
    ...
    addParticipant(publicKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const topicAlgorithm = yield this.getTopicEncryptionAlgorithmFromTopicConfigurationMessage();
            ...
            const topicEncryptionSize = yield this.getTopicEncryptionSizeFromTopicConfigurationMessage();
    ...
    */
    ...
    getEncryptedTopicKeysObjectFromTopicConfigurationMessage() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.topicConfigurationMessageInBase64) {
                yield this.setConfigurationMessageInBase64();
            }
            const topicConfigurationMessage = JSON.parse(Buffer.from(this.topicConfigurationMessageInBase64, 'base64').toString('utf8'));
    ...
    setConfigurationMessageInBase64() {
        return __awaiter(this, void 0, void 0, function* () {
            const topicMemoObject = yield this.getMemo();
            ...
            if (topicMemoObject.s.c.f) {
                ...
                topicConfigurationMessageInBase64 = yield this.getMessageFromTopicInBase64(1);
    ...
    getSubmitKey() {
        return __awaiter(this, void 0, void 0, function* () {
            const topicConfigurationObject = yield this.getTopicConfigurationObject();
