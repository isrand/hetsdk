...
class EncryptedTopic {
  ...
  create(createEncryptedTopicConfiguration) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.topicConfigurationMessage = yield this.createTopicConfigurationMessage({
        submitKey,
  ...
  addParticipant(publicKey, forwardSecrecy) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield this.initializeCrypto(algorithm, size);
      ...
      this.topicConfigurationMessage += newEncryptedTopicEncryptionKeyAndInitVectorsString;
      return true;
    });
  }
  ...
  submitMessage(message) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return yield this.hederaStub.submitMessageToTopic(submitKey, this.topicId, finalMessageInBase64, 'base64');
    });
  }
  ...
  rotateEncryptionKey() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const algorithm = yield this.getEncryptionAlgorithmFromConfigurationMessage();
      const size = yield this.getEncryptionSizeFromConfigurationMessage();
      const newTopicConfigurationMessage = yield this.createTopicConfigurationMessage({
  ...
  createTopicConfigurationMessage(topicConfigurationMessageParameters) {
    return __awaiter(this, void 0, void 0, function* () {
      const { algorithm } = topicConfigurationMessageParameters;
      const { size } = topicConfigurationMessageParameters;
      const { participants } = topicConfigurationMessageParameters;
  ...
  getCurrentTopicConfigurationMessageVersion() {
    return __awaiter(this, void 0, void 0, function* () {
      yield this.setConfigurationMessage();
      const currentTopicConfigurationMessage = this.topicConfigurationMessage.split(',').filter((elem) => elem !== '');
  ...
  getEncryptedTopicKeysObjectFromTopicConfigurationMessage(version) {
    return __awaiter(this, void 0, void 0, function* () {
      yield this.setConfigurationMessage();
      const currentTopicConfigurationMessage = this.topicConfigurationMessage.split(',').filter((elem) => elem !== '');
      const encryptedTopicKeysObjectArray = currentTopicConfigurationMessage[version].split('#').slice(TopicConfigurationMessageIndexes_1.TopicConfigurationMessageIndexes.TOPIC_ENCRYPTED_KEYS_INDEX);
  ...
  getMessageFromTopic(sequenceNumber) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return yield this.hederaStub.getMessageFromTopic(sequenceNumber, this.topicId);
    });
  }
