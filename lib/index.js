...
class EncryptedTopic {
    ...
    create(createEncryptedTopicConfiguration) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const uniqueParticipantsArray = createEncryptedTopicConfiguration.participants.filter((obj, index, self) => index === self.findIndex(o => (o.publicKey === obj.publicKey)));
    ...
    addParticipant(topicId, participant, privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newEncryptedTopicEncryptionKeyAndInitVectors = this.crypto.getEncryptedTopicKeysObject(Buffer.from(topicEncryptionKeyAndInitVector.encryptionKey, 'base64'), Buffer.from(topicEncryptionKeyAndInitVector.initVector, 'base64'), [participant]);
